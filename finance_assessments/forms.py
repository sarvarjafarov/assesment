...
from .models import FinanceQuestion


class FinanceQuestionForm(forms.Form):
    """Render a single Finance assessment question."""

    def __init__(self, *args, question: FinanceQuestion, **kwargs):
        ...
        if q_type in {"multiple_choice", "scenario"}:
            ...
            self.fields["answer"] = forms.CharField(
                ...
                widget=forms.Textarea(
                    attrs={
                        "rows": 5,
                        "placeholder": "Explain your financial reasoning, approach, and any tradeoffs you considered.",
