...
class FinanceQuestionQuerySet(models.QuerySet):
    def published(self):
        return self.filter(is_active=True)


class FinanceQuestion(TimeStampedModel):
    ...
    CATEGORY_RISK_COMPLIANCE = "risk_compliance"
    CATEGORY_STRATEGIC_FINANCE = "strategic_finance"
    CATEGORY_ACCOUNTING_OPS = "accounting_ops"
    CATEGORY_TREASURY = "treasury"
    CATEGORY_BEHAVIORAL = "behavioral"
    CATEGORY_CHOICES = [
        (CATEGORY_FINANCIAL_ANALYSIS, "Financial Planning & Analysis"),
        (CATEGORY_BUDGETING, "Budgeting & Cost Management"),
        (CATEGORY_RISK_COMPLIANCE, "Risk Management & Compliance"),
        (CATEGORY_STRATEGIC_FINANCE, "Strategic Finance"),
        (CATEGORY_ACCOUNTING_OPS, "Accounting & Operations"),
        (CATEGORY_TREASURY, "Treasury & Cash Management"),
        (CATEGORY_BEHAVIORAL, "Behavioral"),
    ]
    ...
    objects = FinanceQuestionQuerySet.as_manager()
...
class FinanceAssessmentSession(TimeStampedModel):
    STATUS_CHOICES = [
        ("draft", "Draft"),
