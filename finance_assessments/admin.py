...
@admin.register(FinanceQuestion)
class FinanceQuestionAdmin(admin.ModelAdmin):
...
@admin.register(FinanceAssessmentSession)
class FinanceAssessmentSessionAdmin(admin.ModelAdmin):
