...
@admin.register(DigitalMarketingQuestion)
class DigitalMarketingQuestionAdmin(admin.ModelAdmin):
...
@admin.register(DigitalMarketingAssessmentSession)
class DigitalMarketingAssessmentSessionAdmin(admin.ModelAdmin):
