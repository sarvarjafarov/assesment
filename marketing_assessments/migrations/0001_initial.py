# Generated by Django 4.2.26 on 2025-11-15 16:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='DigitalMarketingQuestion',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('question_text', models.TextField()),
                ('question_type', models.CharField(choices=[('multiple_choice', 'Multiple choice'), ('scenario', 'Scenario based'), ('ranking', 'Ranking / Ordering'), ('behavioral_most', 'Behavioral - most like me'), ('behavioral_least', 'Behavioral - least like me')], max_length=32)),
                ('difficulty_level', models.PositiveSmallIntegerField(default=3)),
                ('category', models.CharField(choices=[('ppc', 'PPC / Paid Media'), ('seo', 'SEO'), ('analytics', 'Analytics'), ('content', 'Content & Copy'), ('social', 'Social Media'), ('strategy', 'Strategy & Problem Solving'), ('behavioral', 'Behavioral')], max_length=32)),
        ...
        migrations.CreateModel(
            name='DigitalMarketingAssessmentSession',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ...
            options={
                'ordering': ('-created_at',),
                'indexes': [models.Index(fields=['candidate_id'], name='marketing_a_candida_89cb22_idx')],
            },
        ),
    ]
