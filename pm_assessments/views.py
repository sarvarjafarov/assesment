...
class QuestionListView(ApiKeyRequiredMixin, View):
    def get(self, request, candidate_id):
        session = ProductAssessmentSession.objects.get(candidate_id=candidate_id)
        qs = ProductQuestion.objects.filter(id__in=session.question_set)
        questions = [
            {
                "id": q.id,
...
class AssessmentResultView(ApiKeyRequiredMixin, View):
    def get(self, request, candidate_id):
        session = ProductAssessmentSession.objects.get(
