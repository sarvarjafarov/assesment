...
path("verify/<int:account_id>/<slug:token>/", views.ClientVerifyEmailView.as_view(), name="verify-email"),
    ...
    path("guide/", views.PlatformGuideView.as_view(), name="guide"),
    path(
    ...
    path("api/ai-auto-setup/", views.ai_auto_setup, name="ai-auto-setup"),
    ...
    path("dashboard/applications/<uuid:application_uuid>/review/", views.ApplicationReviewView.as_view(), name="application-review"),
