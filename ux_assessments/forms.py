...
from .models import UXDesignQuestion


class UXDesignQuestionForm(forms.Form):
    """Render a single UX/UI design question."""

    def __init__(self, *args, question: UXDesignQuestion, **kwargs):
        ...
        if q_type in {"multiple_choice", "scenario"}:
            ...
            self.fields["answer"] = forms.CharField(
                ...
                widget=forms.Textarea(
                    attrs={
                        "rows": 5,
                        "placeholder": "Explain your design thinking, approach, and any tradeoffs you considered.",
