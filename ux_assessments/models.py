...
class UXDesignQuestionQuerySet(models.QuerySet):
    def published(self):
        return self.filter(is_active=True)


class UXDesignQuestion(TimeStampedModel):
    ...
    CATEGORY_USER_RESEARCH = "user_research"
    CATEGORY_INFORMATION_ARCHITECTURE = "information_architecture"
    CATEGORY_INTERACTION_DESIGN = "interaction_design"
    CATEGORY_VISUAL_DESIGN = "visual_design"
    CATEGORY_USABILITY_ACCESSIBILITY = "usability_accessibility"
    CATEGORY_DESIGN_STRATEGY = "design_strategy"
    CATEGORY_BEHAVIORAL = "behavioral"
    CATEGORY_CHOICES = [
        (CATEGORY_USER_RESEARCH, "User Research"),
        (CATEGORY_INFORMATION_ARCHITECTURE, "Information Architecture"),
        (CATEGORY_INTERACTION_DESIGN, "Interaction Design"),
        (CATEGORY_VISUAL_DESIGN, "Visual Design"),
        (CATEGORY_USABILITY_ACCESSIBILITY, "Usability & Accessibility"),
        (CATEGORY_DESIGN_STRATEGY, "Design Strategy"),
        (CATEGORY_BEHAVIORAL, "Behavioral"),
    ]
    ...
    objects = UXDesignQuestionQuerySet.as_manager()
...
class UXDesignAssessmentSession(TimeStampedModel):
    STATUS_CHOICES = [
        ("draft", "Draft"),
